...
class HT_CTC_Admin_Woo_Page {
    ...
    function ctc_woocommerce_cb() {
        ...
        <p class="description ctc_init_display_none woo_single_position_settings" style="margin-top: 20px;"><strong>New Feature</strong> - Since v3.4. We are planning to improve this feature. For any suggestions please contact us</p>
        ...
        <div class="row ctc_init_display_none woo_single_position_settings">
            ...
            <div class="input-field col s6">
                ...
                <?php _e( "If 'Display Center' is checked, 'Display Block Type': 'block' works better", 'click-to-chat-for-whatsapp' ); ?>
            </div>
        </div>
    ...
    public function options_sanitize( $input ) {
        ...
        foreach ($input as $key => $value) {
            if( isset( $input[$key] ) ) {
                ...
                } elseif ( 'woo_single_margin_top' == $key || 'woo_single_margin_bottom' == $key || 'woo_single_margin_left' == $key || 'woo_single_margin_right' == $key ) {
