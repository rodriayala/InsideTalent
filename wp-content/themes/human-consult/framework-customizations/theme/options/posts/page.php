...
$options = array(
	'hide_breadcrumbs' => array(
		'type'  => 'switch',
		'value' => false,
		'label' => esc_html__('Hide Title section', 'human-consult'),
		'desc'  => esc_html__('You can hide title section with breadcrumbs', 'human-consult'),
		'left-choice' => array(
			'value' => false,
...
$options['page-options-section'] = array(
	'title'   => esc_html__( 'Featured Additional Options', 'human-consult' ),
	'type'    => 'box',
	'context' => 'normal',
	'options' => array(
	),
...
if ( ! empty( $choices ) ) {
	...
	$options_slider = array(
		...
		'no-forms'  => array(
			...
			'html'  =>
				'<div>' .
				'<h1 style="font-weight:100; text-align:center;">' . esc_html__( 'No Sliders Available', 'human-consult' ) . '</h1>' .
				...
				str_replace(
					...
					array(
						...
						fw_html_tag( 'a', array(
							...
							'target' => '_blank',
						), esc_html__( 'create a new Slider', 'human-consult' ) )
					),
					esc_html__( 'No Sliders created yet. Please go to the {br}Sliders page and {add_slider_link}.', 'human-consult' )
				) .
				'</em>' .
				'</p>' .
				'</div>'
