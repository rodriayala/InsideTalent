...
?>
<div class="<?php echo esc_attr( fw_ext_builder_get_item_width( 'form-builder', $item['width'] . '/frontend_class' ) ); echo esc_attr(' ' .$options['icon_color']);?>">
	<div class="form-group<?php echo esc_attr($attr['placeholder']) ? esc_attr(' has-placeholder') : ''; ?>">
		...
		<?php echo !empty($options['icon']) ? '<i class="'.esc_attr($options['icon'] .' '. $options['icon_color']).'"></i>' : '' ?>
