...
$options = array(
	...
	'layout'        => array(
		'label'   => esc_html__( 'Post Layout', 'human-consult' ),
		'desc'    => esc_html__( 'Choose post layout', 'human-consult' ),
		'value'   => 'carousel',
		'type'    => 'select',
		'choices' => array(
	...
	'grayscale_img'  => array(
		'type'         => 'switch',
		'value'        => false,
		'label'        => esc_html__( 'Gray images', 'human-consult' ),
		'desc'         => esc_html__( 'Make images greyscale?', 'human-consult' ),
		'left-choice'  => array(
			'value' => false,
			'label' => esc_html__( 'No', 'human-consult' ),
		),
