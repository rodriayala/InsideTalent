...
if ( count( $terms ) > 1 && $atts['show_filters'] ) { ?>
	<div class="filters portfolio-shortcode-filters isotope_filters-<?php echo esc_attr( $unique_id ); ?> text-center">
		<?php
		if ( $atts['filter_text'] ) {
			echo '<div class="filter_text">'.esc_attr( $atts['filter_text'] ).'</div>';
		}
		?>
		<a href="#" data-filter="*" class="selected"><?php esc_html_e( 'All', 'human-consult' ); ?></a>
		<?php
