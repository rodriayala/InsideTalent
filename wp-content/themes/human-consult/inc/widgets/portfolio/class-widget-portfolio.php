...
if ( class_exists( 'Human_Consult_Widget_Portfolio' ) ) {
	return;
}
...
if ( defined( 'FW' ) ) {
	...
	if ( ! empty( $portfolio ) ) {
		...
		class Human_Consult_Widget_Portfolio extends WP_Widget {
			...
			public function __construct() {
				$widget_ops = array(
					...
					'description' => esc_html__( 'Portfolio projects in carousel or masonry grid', 'human-consult' ),
				);
				parent::__construct( false, esc_html__( 'Theme - Portfolio Projects', 'human-consult' ), $widget_ops );
			}
			...
			public function form( $instance ) {
				...
				<p>
					<label
						for="<?php echo esc_attr( $this->get_field_id( 'number' ) ); ?>"><?php esc_html_e( 'Number of projects', 'human-consult' ); ?>
						:</label>
				...
				<p>
					<label
						for="<?php echo esc_attr( $this->get_field_id( 'layout' ) ); ?>"><?php esc_html_e( 'Gallery layout:', 'human-consult' ) ?></label>
					<select id="<?php echo esc_attr( $this->get_field_id( 'layout' ) ); ?>"
					        name="<?php echo esc_attr( $this->get_field_name( 'layout' ) ); ?>">
						<option <?php selected( $layout, 'carousel' ); ?>
							value="carousel"><?php esc_html_e( 'Carousel', 'human-consult' ) ?></option>
						<option
							<?php selected( $layout, 'isotope' ); ?>value="isotope"><?php esc_html_e( 'Masonry Grid', 'human-consult' ) ?></option>
					</select>
				</p>
				<p>
					...
					<label
						for="<?php echo esc_attr( $this->get_field_id( 'show_filters' ) ); ?>"><?php esc_html_e( 'Show filters', 'human-consult' ); ?></label>
				</p>
				<p>
					<label
						for="<?php echo esc_attr( $this->get_field_id( 'item_layout' ) ); ?>"><?php esc_html_e( 'Gallery Item layout:', 'human-consult' ) ?></label>
					<select id="<?php echo esc_attr( $this->get_field_id( 'item_layout' ) ); ?>"
						...
						<option <?php selected( $item_layout, 'regular' ); ?>
							value="regular"><?php esc_html_e( 'Regular (just image)', 'human-consult' ) ?></option>
						<option
							<?php selected( $item_layout, 'title' ); ?>value="title"><?php esc_html_e( 'Image with title', 'human-consult' ) ?></option>
						<option <?php selected( $item_layout, 'extended' ); ?>
							value="extended"><?php esc_html_e( 'Image with title and excerpt', 'human-consult' ) ?></option>
					</select>
				</p>
				<p>
					<label
						for="<?php echo esc_attr( $this->get_field_id( 'margin' ) ); ?>"><?php esc_html_e( 'Horizontal item margin (px)', 'human-consult' ); ?>
						:</label>
				...
				<p>
					<label
						for="<?php echo esc_attr( $this->get_field_id( 'responsive_lg' ) ); ?>"><?php esc_html_e( 'Columns on >1200px screens', 'human-consult' ); ?>
						:</label>
				...
				<p>
					<label
						for="<?php echo esc_attr( $this->get_field_id( 'responsive_md' ) ); ?>"><?php esc_html_e( 'Columns on >992px screens ', 'human-consult' ); ?>
						:</label>
				...
				<p>
					<label
						for="<?php echo esc_attr( $this->get_field_id( 'responsive_sm' ) ); ?>"><?php esc_html_e( 'Columns on >767px screens', 'human-consult' ); ?>
						:</label>
				...
				<p>
					<label
						for="<?php echo esc_attr( $this->get_field_id( 'responsive_xs' ) ); ?>"><?php esc_html_e( 'Columns on <767px screens', 'human-consult' ); ?>
						:</label>
