...
if ( class_exists( 'Human_Consult_Widget_Posts' ) ) {
	return;
}

class Human_Consult_Widget_Posts extends WP_Widget {
	...
	public function __construct() {
		$widget_ops = array(
			...
			'description' => esc_html__( 'Blog posts in carousel or masonry grid', 'human-consult' ),
		);
		parent::__construct( false, esc_html__( 'Theme - Advanced Blog Posts', 'human-consult' ), $widget_ops );
	}
	...
	public function form( $instance ) {
		...
		<p>
			<label
				for="<?php echo esc_attr( $this->get_field_id( 'number' ) ); ?>"><?php esc_html_e( 'Number of Blog posts', 'human-consult' ); ?>
				:</label>
